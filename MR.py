...
#Here goes parameters for your planet: teff (of the star!),Ms,Rs,P,ecc,sma,Mp,Mp_l,Mp_u,Rp,Rp_l,Rp_u,Jmag
nd = np.array([5788.,1.026,1.088,15.17,0.574,0.1192,1.94,0.092,0.094,1.13,0.051,0.064,10.858])
#Ms P ecc sma Mp Rp
...
plt.errorbar(Mp[-1], Rp[-1], xerr=max(Mpl[-1],Mpu[-1]),
             yerr=max(Rpl[-1],Rpu[-1]),fmt='none', ecolor='C0', zorder=5)
plt.scatter(Mp,Rp,s=ts/2.,c=tq,alpha=0.8, zorder=10)
# plt.plot([Mp[-1]-Mpl[-1],Mp[-1]-0.05],[Rp[-1],Rp[-1]],'C1',alpha=0.9)
# plt.plot([Mp[-1]+0.05,Mp[-1]+Mpu[-1]],[Rp[-1],Rp[-1]],'C1',alpha=0.9)




# plt.scatter(Mp[-1],Rp[-1],s=ts[-1]/2.,c=tq[-1],alpha=0.8)
